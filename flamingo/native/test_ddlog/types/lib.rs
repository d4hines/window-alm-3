...
impl abomonation::Abomonation for ActionChild{}
impl <> record::FromRecord for ActionChild<> {
    fn from_record(val: &record::Record) -> result::Result<Self, String> {
        match val {
            record::Record::PosStruct(constr, _args) => {
                match constr.as_ref() {
                    "NoopAction" if _args.len() == 0 => {
                        Ok(ActionChild::NoopAction{})
                    },
                    "MoveAction" if _args.len() == 3 => {
                        Ok(ActionChild::MoveAction{target: <OID>::from_record(&_args[0])?, delta_x: <std_s64>::from_record(&_args[1])?, delta_y: <std_s64>::from_record(&_args[2])?})
                    },
                    c => result::Result::Err(format!("unknown constructor {} of type ActionChild in {:?}", c, *val))
                }
            },
            record::Record::NamedStruct(constr, _args) => {
                match constr.as_ref() {
                    ...
                    "MoveAction" => {
                        Ok(ActionChild::MoveAction{target: record::arg_extract::<OID>(_args, "target")?, delta_x: record::arg_extract::<std_s64>(_args, "delta_x")?, delta_y: record::arg_extract::<std_s64>(_args, "delta_y")?})
                    },
                    c => result::Result::Err(format!("unknown constructor {} of type ActionChild in {:?}", c, *val))
                }
            },
...
decl_enum_into_record!(ActionChild, <>, NoopAction["NoopAction"]{}, MoveAction["MoveAction"]{target, delta_x, delta_y});
decl_record_mutator_enum!(ActionChild, <>, NoopAction{}, MoveAction{target: OID, delta_x: std_s64, delta_y: std_s64});
impl fmt::Display for ActionChild {
    fn fmt(&self, __formatter: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ActionChild::NoopAction{} => {
                __formatter.write_str("NoopAction{")?;
                __formatter.write_str("}")
            },
            ActionChild::MoveAction{target,delta_x,delta_y} => {
                __formatter.write_str("MoveAction{")?;
                fmt::Debug::fmt(target, __formatter)?;
                __formatter.write_str(",")?;
                fmt::Debug::fmt(delta_x, __formatter)?;
                __formatter.write_str(",")?;
                fmt::Debug::fmt(delta_y, __formatter)?;
                __formatter.write_str("}")
            }
        }
    }
}
impl fmt::Debug for ActionChild {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        fmt::Display::fmt(&self, f)
    }
}
impl  Default for ActionChild {
    fn default() -> Self {
        ActionChild::NoopAction{}
    }
}
...
impl abomonation::Abomonation for Color{}
impl <> record::FromRecord for Color<> {
    fn from_record(val: &record::Record) -> result::Result<Self, String> {
        match val {
            record::Record::PosStruct(constr, _args) => {
                match constr.as_ref() {
                    ...
                    c => result::Result::Err(format!("unknown constructor {} of type Color in {:?}", c, *val))
                }
            },
            record::Record::NamedStruct(constr, _args) => {
                match constr.as_ref() {
...
decl_enum_into_record!(Color, <>, Red["Red"]{}, Blue["Blue"]{});
decl_record_mutator_enum!(Color, <>, Red{}, Blue{});
impl fmt::Display for Color {
    fn fmt(&self, __formatter: &mut fmt::Formatter) -> fmt::Result {
        match self {
            Color::Red{} => {
                __formatter.write_str("Red{")?;
                __formatter.write_str("}")
            },
            Color::Blue{} => {
                __formatter.write_str("Blue{")?;
                __formatter.write_str("}")
            }
        }
    }
...
impl abomonation::Abomonation for Output_MagicRectangle{}
impl <> record::FromRecord for Output_MagicRectangle<> {
    fn from_record(val: &record::Record) -> result::Result<Self, String> {
        match val {
            record::Record::PosStruct(constr, _args) => {
                match constr.as_ref() {
                    "Output_MagicRectangle" if _args.len() == 6 => {
                        Ok(Output_MagicRectangle{oid: <OID>::from_record(&_args[0])?, x: <std_s64>::from_record(&_args[1])?, y: <std_s64>::from_record(&_args[2])?, width: <std_s64>::from_record(&_args[3])?, height: <std_s64>::from_record(&_args[4])?, color: <Color>::from_record(&_args[5])?})
                    },
                    c => result::Result::Err(format!("unknown constructor {} of type Output_MagicRectangle in {:?}", c, *val))
                }
            },
            record::Record::NamedStruct(constr, _args) => {
                match constr.as_ref() {
                    "Output_MagicRectangle" => {
                        Ok(Output_MagicRectangle{oid: record::arg_extract::<OID>(_args, "oid")?, x: record::arg_extract::<std_s64>(_args, "x")?, y: record::arg_extract::<std_s64>(_args, "y")?, width: record::arg_extract::<std_s64>(_args, "width")?, height: record::arg_extract::<std_s64>(_args, "height")?, color: record::arg_extract::<Color>(_args, "color")?})
                    },
                    c => result::Result::Err(format!("unknown constructor {} of type Output_MagicRectangle in {:?}", c, *val))
                }
            },
...
decl_struct_into_record!(Output_MagicRectangle["Output_MagicRectangle"]<>, oid, x, y, width, height, color);
decl_record_mutator_struct!(Output_MagicRectangle, <>, oid: OID, x: std_s64, y: std_s64, width: std_s64, height: std_s64, color: Color);
impl fmt::Display for Output_MagicRectangle {
    fn fmt(&self, __formatter: &mut fmt::Formatter) -> fmt::Result {
        match self {
            Output_MagicRectangle{oid,x,y,width,height,color} => {
                __formatter.write_str("Output_MagicRectangle{")?;
                fmt::Debug::fmt(oid, __formatter)?;
                __formatter.write_str(",")?;
                fmt::Debug::fmt(x, __formatter)?;
                __formatter.write_str(",")?;
                fmt::Debug::fmt(y, __formatter)?;
                __formatter.write_str(",")?;
                fmt::Debug::fmt(width, __formatter)?;
                __formatter.write_str(",")?;
                fmt::Debug::fmt(height, __formatter)?;
                __formatter.write_str(",")?;
                fmt::Debug::fmt(color, __formatter)?;
                __formatter.write_str("}")
            }
        }
    }
}
impl fmt::Debug for Output_MagicRectangle {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        fmt::Display::fmt(&self, f)
    }
}
#[derive(Eq, Ord, Clone, Hash, PartialEq, PartialOrd, Serialize, Deserialize, Default)]
pub struct RectangleChild {
    pub color: Color
}
impl abomonation::Abomonation for RectangleChild{}
impl <> record::FromRecord for RectangleChild<> {
    fn from_record(val: &record::Record) -> result::Result<Self, String> {
        match val {
            record::Record::PosStruct(constr, _args) => {
                match constr.as_ref() {
                    "MagicRectangle" if _args.len() == 1 => {
                        Ok(RectangleChild{color: <Color>::from_record(&_args[0])?})
                    },
                    c => result::Result::Err(format!("unknown constructor {} of type RectangleChild in {:?}", c, *val))
                }
            },
            record::Record::NamedStruct(constr, _args) => {
                match constr.as_ref() {
                    "MagicRectangle" => {
                        Ok(RectangleChild{color: record::arg_extract::<Color>(_args, "color")?})
                    },
                    c => result::Result::Err(format!("unknown constructor {} of type RectangleChild in {:?}", c, *val))
                }
            },
...
decl_struct_into_record!(RectangleChild["RectangleChild"]<>, color);
decl_record_mutator_struct!(RectangleChild, <>, color: Color);
impl fmt::Display for RectangleChild {
    fn fmt(&self, __formatter: &mut fmt::Formatter) -> fmt::Result {
        match self {
            RectangleChild{color} => {
                __formatter.write_str("MagicRectangle{")?;
                fmt::Debug::fmt(color, __formatter)?;
                __formatter.write_str("}")
            }
        }
...
impl fmt::Debug for RectangleChild {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        fmt::Display::fmt(&self, f)
    }
}
...
pub struct Universe {
    pub oid: OID,
    pub universeChild: UniverseChild
}
impl abomonation::Abomonation for Universe{}
impl <> record::FromRecord for Universe<> {
    fn from_record(val: &record::Record) -> result::Result<Self, String> {
        match val {
            record::Record::PosStruct(constr, _args) => {
                match constr.as_ref() {
                    "Universe" if _args.len() == 2 => {
                        Ok(Universe{oid: <OID>::from_record(&_args[0])?, universeChild: <UniverseChild>::from_record(&_args[1])?})
                    },
                    c => result::Result::Err(format!("unknown constructor {} of type Universe in {:?}", c, *val))
                }
            },
            record::Record::NamedStruct(constr, _args) => {
                match constr.as_ref() {
                    "Universe" => {
                        Ok(Universe{oid: record::arg_extract::<OID>(_args, "oid")?, universeChild: record::arg_extract::<UniverseChild>(_args, "universeChild")?})
                    },
                    c => result::Result::Err(format!("unknown constructor {} of type Universe in {:?}", c, *val))
                }
            },
...
decl_struct_into_record!(Universe["Universe"]<>, oid, universeChild);
decl_record_mutator_struct!(Universe, <>, oid: OID, universeChild: UniverseChild);
impl fmt::Display for Universe {
    fn fmt(&self, __formatter: &mut fmt::Formatter) -> fmt::Result {
        match self {
            Universe{oid,universeChild} => {
                __formatter.write_str("Universe{")?;
                fmt::Debug::fmt(oid, __formatter)?;
                __formatter.write_str(",")?;
                fmt::Debug::fmt(universeChild, __formatter)?;
                __formatter.write_str("}")
            }
        }
    }
...
impl abomonation::Abomonation for UniverseChild{}
impl <> record::FromRecord for UniverseChild<> {
    fn from_record(val: &record::Record) -> result::Result<Self, String> {
        match val {
            record::Record::PosStruct(constr, _args) => {
                match constr.as_ref() {
                    "Action" if _args.len() == 1 => {
                        Ok(UniverseChild::Action{actionChild: <ActionChild>::from_record(&_args[0])?})
                    },
                    "Rectangle" if _args.len() == 5 => {
                        Ok(UniverseChild::Rectangle{x: <std_s64>::from_record(&_args[0])?, y: <std_s64>::from_record(&_args[1])?, width: <std_s64>::from_record(&_args[2])?, height: <std_s64>::from_record(&_args[3])?, rectangleChild: <RectangleChild>::from_record(&_args[4])?})
                    },
                    c => result::Result::Err(format!("unknown constructor {} of type UniverseChild in {:?}", c, *val))
                }
            },
            record::Record::NamedStruct(constr, _args) => {
                match constr.as_ref() {
                    "Action" => {
                        Ok(UniverseChild::Action{actionChild: record::arg_extract::<ActionChild>(_args, "actionChild")?})
                    },
                    "Rectangle" => {
                        Ok(UniverseChild::Rectangle{x: record::arg_extract::<std_s64>(_args, "x")?, y: record::arg_extract::<std_s64>(_args, "y")?, width: record::arg_extract::<std_s64>(_args, "width")?, height: record::arg_extract::<std_s64>(_args, "height")?, rectangleChild: record::arg_extract::<RectangleChild>(_args, "rectangleChild")?})
                    },
                    c => result::Result::Err(format!("unknown constructor {} of type UniverseChild in {:?}", c, *val))
                }
            },
...
decl_enum_into_record!(UniverseChild, <>, Action["Action"]{actionChild}, Rectangle["Rectangle"]{x, y, width, height, rectangleChild});
decl_record_mutator_enum!(UniverseChild, <>, Action{actionChild: ActionChild}, Rectangle{x: std_s64, y: std_s64, width: std_s64, height: std_s64, rectangleChild: RectangleChild});
impl fmt::Display for UniverseChild {
    fn fmt(&self, __formatter: &mut fmt::Formatter) -> fmt::Result {
        match self {
            UniverseChild::Action{actionChild} => {
                __formatter.write_str("Action{")?;
                fmt::Debug::fmt(actionChild, __formatter)?;
                __formatter.write_str("}")
            },
            UniverseChild::Rectangle{x,y,width,height,rectangleChild} => {
                __formatter.write_str("Rectangle{")?;
                fmt::Debug::fmt(x, __formatter)?;
                __formatter.write_str(",")?;
                fmt::Debug::fmt(y, __formatter)?;
                __formatter.write_str(",")?;
                ...
                fmt::Debug::fmt(height, __formatter)?;
                __formatter.write_str(",")?;
                fmt::Debug::fmt(rectangleChild, __formatter)?;
                __formatter.write_str("}")
            }
        }
    }
}
impl fmt::Debug for UniverseChild {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        fmt::Display::fmt(&self, f)
    }
}
impl  Default for UniverseChild {
    fn default() -> Self {
        UniverseChild::Action{actionChild : Default::default()}
    }
}
...
impl <A: record::FromRecord + serde::de::DeserializeOwned + Default> record::FromRecord for std_Option<A> {
    fn from_record(val: &record::Record) -> result::Result<Self, String> {
        match val {
            record::Record::PosStruct(constr, _args) => {
                match constr.as_ref() {
                    ...
                    c => result::Result::Err(format!("unknown constructor {} of type std_Option in {:?}", c, *val))
                }
            },
            record::Record::NamedStruct(constr, _args) => {
                match constr.as_ref() {
...
/* fn std_group2map<K1: Val,K2: Val,V: Val>(g: & std_Group<K1, (K2, V)>) -> std_Map<K2, V> */
/* fn std_group2set<K: Val,V: Val>(g: & std_Group<K, V>) -> std_Set<V> */
/* fn std_group2setmap<K1: Val,K2: Val,V: Val>(g: & std_Group<K1, (K2, V)>) -> std_Map<K2, std_Set<V>> */
/* fn std_group2vec<K: Val,V: Val>(g: & std_Group<K, V>) -> std_Vec<V> */
...
/* fn std_set2vec<A: Val>(s: & std_Set<A>) -> std_Vec<A> */
...
/* fn std_vec2set<A: Val>(s: & std_Vec<A>) -> std_Set<A> */
...
/* fn std_vec_sort<X: Val>(v: & std_Vec<X>) -> () */
...
pub fn std_max<A: Val>(x: & A, y: & A) -> A
{   if ((&*x) > (&*y)) {
        x.clone()
    } else {
        y.clone()
...
pub fn std_min<A: Val>(x: & A, y: & A) -> A
{   if ((&*x) < (&*y)) {
        x.clone()
    } else {
        y.clone()
...
pub fn std_option2set<X: Val>(o: & std_Option<X>) -> std_Set<X>
{   match (*o) {
        std_Option::std_Some{x: ref x} => std_set_singleton(x),
        std_Option::std_None{} => std_set_empty()
    }
}
pub fn std_option2vec<X: Val>(o: & std_Option<X>) -> std_Vec<X>
{   match (*o) {
        std_Option::std_Some{x: ref x} => std_vec_singleton(x),
        std_Option::std_None{} => std_vec_empty()
    }
}
pub fn std_option_unwrap_or<A: Val>(x: & std_Option<A>, def: & A) -> A
{   match (*x) {
        std_Option::std_Some{x: ref v} => v.clone(),
        std_Option::std_None{} => def.clone()
    }
}
pub fn std_result_unwrap_or<V: Val,E: Val>(res: & std_Result<V, E>, def: & V) -> V
{   match (*res) {
